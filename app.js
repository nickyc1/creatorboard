...
const owners = ["Ben", "Unassigned", "Maddie", "Jake", "Support"];
    ...
    creators: [
      {
        id: "sample-lacey",
        name: "Lacey Bland",
        handle: "@lacefit_fitness",
        niche: "Fitness / Lifestyle",
        igFollowers: "89,200",
        code: "LACEY10",
        owner: "Ben",
        status: "needs-reply",
        nextStep: "Reply and collect address, shirt size, PayPal, and partnership access.",
        checklist: { shipping: false, paypal: false, assets: false, access: false, paid: false },
        spend: {},
        dms: [{ id: "dm-lacey", identity: "@lacefit_fitness", direction: "outbound", time: "24m", message: "Hey, Lacey. We send free gear, you film simple raw videos, and we run the ads from your page." }],
      },
      {
        id: "sample-ty",
        name: "Ty Kuhn",
        ...
        owner: "Jake",
        status: "team-action",
        nextStep: "Need shipping address before fulfillment can send gear.",
        ...
        dms: [{ id: "dm-ty", identity: "@tykuhnfit", direction: "inbound", time: "2h", message: "Yup I accepted it. Sounds good." }],
      },
      {
        id: "sample-matt",
        name: "Matt Brown",
        handle: "@thamattbrownn",
        niche: "Trades",
        igFollowers: "29,800",
        code: "BROWN10",
        owner: "Maddie",
        ...
        dms: [{ id: "dm-matt", identity: "@thamattbrownn", direction: "inbound", time: "11h", message: "I can definitely put together a couple videos this week." }],
      },
    ],
    dms: [],
    unmatched: [],
